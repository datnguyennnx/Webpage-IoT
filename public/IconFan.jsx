...
function IconFan(props) {
  return (
    ...
    {props.value ? <animateTransform attributeType="xml" attributeName="transform" type="rotate" from="360 4.4 5.5" to="0 4.4 5.5" dur="0.5s" additive="sum" repeatCount="indefinite" /> : null}
